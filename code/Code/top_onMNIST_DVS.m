...
numTotal = 10000 %100 %10000;     % number of samples totally
ratio_Trn = 0.9 %0.8;
...
if ( (reRunAll) || (reGenCINs) || ~exist(CINsfile,'file') )
    sourceMatFile = ['MNIST_DVS_28x28_' num2str(numTotal) '_200ms.mat']; 
	% In this .mat file, each event stream is about 200ms. 
...
%         IsTraining, 'testing set',folder0, 1, lmd);
